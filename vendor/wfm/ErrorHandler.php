...
class ErrorHandler
{
    ...
    public function fatalErrorHandler()
    {
        ...
        if(!empty($error) && $error['type'] & (E_ERROR | E_PARSE | E_COMPILE_ERROR | E_CORE_ERROR)){
            ...
            ob_end_clean();
            $this->displayError($error['type'], $error['message'], $error['file'], $error['line'], $error['code']);
        }else{
            ob_end_flush();
        }
    }
    ...
    {
        file_put_contents(LOGS . '/errors.log', "[" . date('D-m-Y H:i:s') . "] Текст ошибки: {$message} | Файл: {$file} | Строка: {$line} \n===================\n", FILE_APPEND) ;
    }
